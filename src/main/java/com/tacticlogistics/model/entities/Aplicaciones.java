 ...
 */
@Entity
@Table(name = "Aplicaciones", catalog = "dbo")
public class Aplicaciones implements java.io.Serializable {
	...
	public Aplicaciones(String aplicacionId, String nombre, String descripcion, short ordinal, boolean activo,
	...
	@Column(name = "Aplicacion_Id", unique = true, nullable = false, length = 20)
