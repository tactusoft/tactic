...
/**
 * LineasOrdenTrabajo generated by hbm2java
 */
@Entity
@Table(name = "Lineas_Orden_Trabajo", schema = "demo", catalog = "esbTactic")
public class LineasOrdenTrabajo implements java.io.Serializable {

	private static final long serialVersionUID = 1L;
	
	private LineasOrdenTrabajoId id;
	private OrdenesTrabajo ordenesTrabajo;
	...
	public LineasOrdenTrabajo() {
	}

	public LineasOrdenTrabajo(LineasOrdenTrabajoId id, OrdenesTrabajo ordenesTrabajo, String idProducto,
	...
	@AttributeOverrides({
			@AttributeOverride(name = "idOrdenTrabajo", column = @Column(name = "Id_Orden_Trabajo", nullable = false) ),
			@AttributeOverride(name = "numeroLinea", column = @Column(name = "Numero_Linea", nullable = false) ) })
	public LineasOrdenTrabajoId getId() {
		return this.id;
	}

	public void setId(LineasOrdenTrabajoId id) {
		this.id = id;
	}

	@ManyToOne(fetch = FetchType.LAZY)
	@JoinColumn(name = "Id_Orden_Trabajo", nullable = false, insertable = false, updatable = false)
	public OrdenesTrabajo getOrdenesTrabajo() {
		return this.ordenesTrabajo;
	}

	public void setOrdenesTrabajo(OrdenesTrabajo ordenesTrabajo) {
		this.ordenesTrabajo = ordenesTrabajo;
	}
